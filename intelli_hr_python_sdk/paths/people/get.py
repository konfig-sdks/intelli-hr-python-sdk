...
from intelli_hr_python_sdk.model.people_list import PeopleList as PeopleListSchema

from intelli_hr_python_sdk.type.people_list import PeopleList

from ...api_client import Dictionary
from intelli_hr_python_sdk.pydantic.people_list import PeopleList as PeopleListPydantic
...
class FiltersSchema(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            updatedWithin = schemas.NumberSchema
            isOnExtendedLeave = schemas.StrSchema
            __annotations__ = {
                "jobId": jobId,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["jobId", "primaryEmailAddress", "employeeNumber", "autoIncrementIntellihrId", "name", "updatedWithin", "isOnExtendedLeave", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["jobId", "primaryEmailAddress", "employeeNumber", "autoIncrementIntellihrId", "name", "updatedWithin", "isOnExtendedLeave", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        updatedWithin: typing.Union[MetaOapg.properties.updatedWithin, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        isOnExtendedLeave: typing.Union[MetaOapg.properties.isOnExtendedLeave, str, schemas.Unset] = schemas.unset,
...
SchemaFor200ResponseBodyApplicationJson = PeopleListSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_all_people_mapped_args(
        self,
    ...
    async def _alist_all_people_oapg(
        self,
...
class ListAllPeopleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_all_people(
        self,
        filters: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        sort: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_all_people_mapped_args(
            filters=filters,
            sort=sort,
        )
        return await self._alist_all_people_oapg(
    ...
    def list_all_people(
        ...
        return self._list_all_people_oapg(
            query_params=args.query,
        )

class ListAllPeople(BaseApi):
    ...
    async def alist_all_people(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_all_people(
            filters=filters,
            sort=sort,
            **kwargs,
        )
        if validate:
            return PeopleListPydantic(**raw_response.body)
        return api_client.construct_model_instance(PeopleListPydantic, raw_response.body)
    ...
    def list_all_people(
        ...
        raw_response = self.raw.list_all_people(
            filters=filters,
            sort=sort,
        )
        if validate:
