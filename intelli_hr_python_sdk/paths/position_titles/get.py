...
from intelli_hr_python_sdk.model.position_titles_list import PositionTitlesList as PositionTitlesListSchema

from intelli_hr_python_sdk.type.position_titles_list import PositionTitlesList

from ...api_client import Dictionary
from intelli_hr_python_sdk.pydantic.position_titles_list import PositionTitlesList as PositionTitlesListPydantic
...
SchemaFor200ResponseBodyApplicationJson = PositionTitlesListSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PositionTitlesList
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PositionTitlesListPydantic:
        raw_response = await self.raw.alist_all(
            filters=filters,
            **kwargs,
        )
        if validate:
            return PositionTitlesListPydantic(**raw_response.body)
        return api_client.construct_model_instance(PositionTitlesListPydantic, raw_response.body)
