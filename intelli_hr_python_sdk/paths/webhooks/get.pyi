...
from intelli_hr_python_sdk.model.webhooks_list import WebhooksList as WebhooksListSchema

from intelli_hr_python_sdk.type.webhooks_list import WebhooksList

from ...api_client import Dictionary
from intelli_hr_python_sdk.pydantic.webhooks_list import WebhooksList as WebhooksListPydantic

SchemaFor200ResponseBodyApplicationJson = WebhooksListSchema
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> WebhooksListPydantic:
        raw_response = await self.raw.alist_all(
            **kwargs,
        )
        if validate:
            return WebhooksListPydantic(**raw_response.body)
        return api_client.construct_model_instance(WebhooksListPydantic, raw_response.body)
