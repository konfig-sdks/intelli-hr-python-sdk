...
from intelli_hr_python_sdk.model.business_units_list import BusinessUnitsList as BusinessUnitsListSchema

from intelli_hr_python_sdk.type.business_units_list import BusinessUnitsList

from ...api_client import Dictionary
from intelli_hr_python_sdk.pydantic.business_units_list import BusinessUnitsList as BusinessUnitsListPydantic
...
class FiltersSchema(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["identifier", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["identifier", "name", ], str]):
...
SchemaFor200ResponseBodyApplicationJson = BusinessUnitsListSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BusinessUnitsList
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BusinessUnitsListPydantic:
        raw_response = await self.raw.alist_all(
            filters=filters,
            **kwargs,
        )
        if validate:
            return BusinessUnitsListPydantic(**raw_response.body)
        return api_client.construct_model_instance(BusinessUnitsListPydantic, raw_response.body)
