...
from intelli_hr_python_sdk.model.permission_groups_list import PermissionGroupsList as PermissionGroupsListSchema

from intelli_hr_python_sdk.type.permission_groups_list import PermissionGroupsList

from ...api_client import Dictionary
from intelli_hr_python_sdk.pydantic.permission_groups_list import PermissionGroupsList as PermissionGroupsListPydantic
...
SchemaFor200ResponseBodyApplicationJson = PermissionGroupsListSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PermissionGroupsList
    ...
    async def _alist_all_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/permission-groups',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PermissionGroupsListPydantic:
        raw_response = await self.raw.alist_all(
            filters=filters,
            **kwargs,
        )
        if validate:
            return PermissionGroupsListPydantic(**raw_response.body)
        return api_client.construct_model_instance(PermissionGroupsListPydantic, raw_response.body)
