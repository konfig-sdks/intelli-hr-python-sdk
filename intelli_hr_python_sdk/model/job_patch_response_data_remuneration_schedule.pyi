...
class JobPatchResponseDataRemunerationSchedule(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def employmentCondition() -> typing.Type['JobPatchResponseDataRemunerationScheduleEmploymentCondition']:
                return JobPatchResponseDataRemunerationScheduleEmploymentCondition
        
            @staticmethod
            def additions() -> typing.Type['JobPatchResponseDataRemunerationScheduleAdditions']:
                return JobPatchResponseDataRemunerationScheduleAdditions
        
            @staticmethod
            def deductions() -> typing.Type['JobPatchResponseDataRemunerationScheduleDeductions']:
                return JobPatchResponseDataRemunerationScheduleDeductions
        
            @staticmethod
            def additionsToTotal() -> typing.Type['JobPatchResponseDataRemunerationScheduleAdditionsToTotal']:
                return JobPatchResponseDataRemunerationScheduleAdditionsToTotal
        
            @staticmethod
            def breakdowns() -> typing.Type['JobPatchResponseDataRemunerationScheduleBreakdowns']:
                return JobPatchResponseDataRemunerationScheduleBreakdowns
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["employmentCondition"]) -> 'JobPatchResponseDataRemunerationScheduleEmploymentCondition': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["additions"]) -> 'JobPatchResponseDataRemunerationScheduleAdditions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["deductions"]) -> 'JobPatchResponseDataRemunerationScheduleDeductions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["additionsToTotal"]) -> 'JobPatchResponseDataRemunerationScheduleAdditionsToTotal': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["breakdowns"]) -> 'JobPatchResponseDataRemunerationScheduleBreakdowns': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["employmentCondition"]) -> typing.Union['JobPatchResponseDataRemunerationScheduleEmploymentCondition', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["additions"]) -> typing.Union['JobPatchResponseDataRemunerationScheduleAdditions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["deductions"]) -> typing.Union['JobPatchResponseDataRemunerationScheduleDeductions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["additionsToTotal"]) -> typing.Union['JobPatchResponseDataRemunerationScheduleAdditionsToTotal', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["breakdowns"]) -> typing.Union['JobPatchResponseDataRemunerationScheduleBreakdowns', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        employmentCondition: typing.Union['JobPatchResponseDataRemunerationScheduleEmploymentCondition', schemas.Unset] = schemas.unset,
        additions: typing.Union['JobPatchResponseDataRemunerationScheduleAdditions', schemas.Unset] = schemas.unset,
        deductions: typing.Union['JobPatchResponseDataRemunerationScheduleDeductions', schemas.Unset] = schemas.unset,
        additionsToTotal: typing.Union['JobPatchResponseDataRemunerationScheduleAdditionsToTotal', schemas.Unset] = schemas.unset,
        breakdowns: typing.Union['JobPatchResponseDataRemunerationScheduleBreakdowns', schemas.Unset] = schemas.unset,
        customFields: typing.Union['CustomFieldsResponse', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'JobPatchResponseDataRemunerationSchedule':
