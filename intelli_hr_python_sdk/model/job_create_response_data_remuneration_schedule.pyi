...
class JobCreateResponseDataRemunerationSchedule(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def employmentCondition() -> typing.Type['JobCreateResponseDataRemunerationScheduleEmploymentCondition']:
                return JobCreateResponseDataRemunerationScheduleEmploymentCondition
        
            @staticmethod
            def additions() -> typing.Type['JobCreateResponseDataRemunerationScheduleAdditions']:
                return JobCreateResponseDataRemunerationScheduleAdditions
        
            @staticmethod
            def deductions() -> typing.Type['JobCreateResponseDataRemunerationScheduleDeductions']:
                return JobCreateResponseDataRemunerationScheduleDeductions
        
            @staticmethod
            def additionsToTotal() -> typing.Type['JobCreateResponseDataRemunerationScheduleAdditionsToTotal']:
                return JobCreateResponseDataRemunerationScheduleAdditionsToTotal
        
            @staticmethod
            def breakdowns() -> typing.Type['JobCreateResponseDataRemunerationScheduleBreakdowns']:
                return JobCreateResponseDataRemunerationScheduleBreakdowns
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["employmentCondition"]) -> 'JobCreateResponseDataRemunerationScheduleEmploymentCondition': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["additions"]) -> 'JobCreateResponseDataRemunerationScheduleAdditions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["deductions"]) -> 'JobCreateResponseDataRemunerationScheduleDeductions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["additionsToTotal"]) -> 'JobCreateResponseDataRemunerationScheduleAdditionsToTotal': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["breakdowns"]) -> 'JobCreateResponseDataRemunerationScheduleBreakdowns': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["employmentCondition"]) -> typing.Union['JobCreateResponseDataRemunerationScheduleEmploymentCondition', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["additions"]) -> typing.Union['JobCreateResponseDataRemunerationScheduleAdditions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["deductions"]) -> typing.Union['JobCreateResponseDataRemunerationScheduleDeductions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["additionsToTotal"]) -> typing.Union['JobCreateResponseDataRemunerationScheduleAdditionsToTotal', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["breakdowns"]) -> typing.Union['JobCreateResponseDataRemunerationScheduleBreakdowns', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        employmentCondition: typing.Union['JobCreateResponseDataRemunerationScheduleEmploymentCondition', schemas.Unset] = schemas.unset,
        additions: typing.Union['JobCreateResponseDataRemunerationScheduleAdditions', schemas.Unset] = schemas.unset,
        deductions: typing.Union['JobCreateResponseDataRemunerationScheduleDeductions', schemas.Unset] = schemas.unset,
        additionsToTotal: typing.Union['JobCreateResponseDataRemunerationScheduleAdditionsToTotal', schemas.Unset] = schemas.unset,
        breakdowns: typing.Union['JobCreateResponseDataRemunerationScheduleBreakdowns', schemas.Unset] = schemas.unset,
        customFields: typing.Union['CustomFieldsResponse', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'JobCreateResponseDataRemunerationSchedule':
