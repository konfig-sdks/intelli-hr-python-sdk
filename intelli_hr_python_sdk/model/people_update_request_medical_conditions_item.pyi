...
class PeopleUpdateRequestMedicalConditionsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["body", "isPublic", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["body", "isPublic", ], str]):
    ...
    ) -> 'PeopleUpdateRequestMedicalConditionsItem':
