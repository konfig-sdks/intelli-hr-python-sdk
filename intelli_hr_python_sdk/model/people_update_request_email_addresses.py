...
class PeopleUpdateRequestEmailAddresses(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        class items(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "isPersonal", "isPrimary", "customFields", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "isPersonal", "isPrimary", "customFields", ], str]):
                return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        _configuration: typing.Optional[schemas.Configuration] = None,
    ) -> 'PeopleUpdateRequestEmailAddresses':
        return super().__new__(
            cls,
            arg,
            _configuration=_configuration,
