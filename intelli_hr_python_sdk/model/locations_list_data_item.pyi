...
class LocationsListDataItem(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def representatives() -> typing.Type['LocationsListDataItemRepresentatives']:
                return LocationsListDataItemRepresentatives
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["representatives"]) -> 'LocationsListDataItemRepresentatives': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "parentId", "name", "code", "address", "isEnabled", "representatives", "customFields", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["representatives"]) -> typing.Union['LocationsListDataItemRepresentatives', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "parentId", "name", "code", "address", "isEnabled", "representatives", "customFields", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        representatives: typing.Union['LocationsListDataItemRepresentatives', schemas.Unset] = schemas.unset,
        customFields: typing.Union['CustomFieldsResponse', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'LocationsListDataItem':
        return super().__new__(
            cls,
            *args,
            id=id,
