...
class PayGradeCreateRequestPaySteps(
    schemas.ListSchema
):
    """NOTE:
    ...
    class MetaOapg:
        ...
        class items(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "permanentHourlyRate", "permanentHourlyRateCurrency", "casualHourlyRate", "casualHourlyRateCurrency", "annualSalary", "annualSalaryCurrency", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "permanentHourlyRate", "permanentHourlyRateCurrency", "casualHourlyRate", "casualHourlyRateCurrency", "annualSalary", "annualSalaryCurrency", ], str]):
