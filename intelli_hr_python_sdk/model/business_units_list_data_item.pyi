...
class BusinessUnitsListDataItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "identifier", "name", "code", "notes", "parentId", "isEnabled", "customFields", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "identifier", "name", "code", "notes", "parentId", "isEnabled", "customFields", ], str]):
