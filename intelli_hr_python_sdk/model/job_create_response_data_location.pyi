...
class JobCreateResponseDataLocation(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "address", "code", "customFields", "link", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "address", "code", "customFields", "link", ], str]):
