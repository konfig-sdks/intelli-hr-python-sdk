...
class WebhookEvent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "event", "timestamp", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "event", "timestamp", ], str]):
