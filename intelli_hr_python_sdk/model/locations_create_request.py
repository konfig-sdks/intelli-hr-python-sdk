...
class LocationsCreateRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def customFields() -> typing.Type['LocationsCreateRequestCustomFields']:
                return LocationsCreateRequestCustomFields
            __annotations__ = {
                "name": name,
                "parentId": parentId,
                "code": code,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["customFields"]) -> 'LocationsCreateRequestCustomFields': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "parentId", "code", "address", "isEnabled", "customFields", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["customFields"]) -> typing.Union['LocationsCreateRequestCustomFields', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "parentId", "code", "address", "isEnabled", "customFields", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        customFields: typing.Union['LocationsCreateRequestCustomFields', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
