...
class JobsListDataItemRemunerationSchedule(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def employmentCondition() -> typing.Type['JobsListDataItemRemunerationScheduleEmploymentCondition']:
                return JobsListDataItemRemunerationScheduleEmploymentCondition
        
            @staticmethod
            def additions() -> typing.Type['JobsListDataItemRemunerationScheduleAdditions']:
                return JobsListDataItemRemunerationScheduleAdditions
        
            @staticmethod
            def deductions() -> typing.Type['JobsListDataItemRemunerationScheduleDeductions']:
                return JobsListDataItemRemunerationScheduleDeductions
        
            @staticmethod
            def additionsToTotal() -> typing.Type['JobsListDataItemRemunerationScheduleAdditionsToTotal']:
                return JobsListDataItemRemunerationScheduleAdditionsToTotal
        
            @staticmethod
            def breakdowns() -> typing.Type['JobsListDataItemRemunerationScheduleBreakdowns']:
                return JobsListDataItemRemunerationScheduleBreakdowns
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["employmentCondition"]) -> 'JobsListDataItemRemunerationScheduleEmploymentCondition': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["additions"]) -> 'JobsListDataItemRemunerationScheduleAdditions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["deductions"]) -> 'JobsListDataItemRemunerationScheduleDeductions': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["additionsToTotal"]) -> 'JobsListDataItemRemunerationScheduleAdditionsToTotal': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["breakdowns"]) -> 'JobsListDataItemRemunerationScheduleBreakdowns': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["employmentCondition"]) -> typing.Union['JobsListDataItemRemunerationScheduleEmploymentCondition', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["additions"]) -> typing.Union['JobsListDataItemRemunerationScheduleAdditions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["deductions"]) -> typing.Union['JobsListDataItemRemunerationScheduleDeductions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["additionsToTotal"]) -> typing.Union['JobsListDataItemRemunerationScheduleAdditionsToTotal', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["breakdowns"]) -> typing.Union['JobsListDataItemRemunerationScheduleBreakdowns', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        employmentCondition: typing.Union['JobsListDataItemRemunerationScheduleEmploymentCondition', schemas.Unset] = schemas.unset,
        additions: typing.Union['JobsListDataItemRemunerationScheduleAdditions', schemas.Unset] = schemas.unset,
        deductions: typing.Union['JobsListDataItemRemunerationScheduleDeductions', schemas.Unset] = schemas.unset,
        additionsToTotal: typing.Union['JobsListDataItemRemunerationScheduleAdditionsToTotal', schemas.Unset] = schemas.unset,
        breakdowns: typing.Union['JobsListDataItemRemunerationScheduleBreakdowns', schemas.Unset] = schemas.unset,
        customFields: typing.Union['CustomFieldsResponse', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'JobsListDataItemRemunerationSchedule':
