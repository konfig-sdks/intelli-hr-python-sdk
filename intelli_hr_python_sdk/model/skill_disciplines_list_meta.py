...
class SkillDisciplinesListMeta(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def pagination() -> typing.Type['SkillDisciplinesListMetaPagination']:
                return SkillDisciplinesListMetaPagination
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["pagination"]) -> 'SkillDisciplinesListMetaPagination': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["pagination"]) -> typing.Union['SkillDisciplinesListMetaPagination', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        pagination: typing.Union['SkillDisciplinesListMetaPagination', schemas.Unset] = schemas.unset,
