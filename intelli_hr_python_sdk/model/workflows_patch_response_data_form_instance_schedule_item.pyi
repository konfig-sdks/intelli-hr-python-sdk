...
class WorkflowsPatchResponseDataFormInstanceScheduleItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "issueDate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "issueDate", ], str]):
    ...
    ) -> 'WorkflowsPatchResponseDataFormInstanceScheduleItem':
