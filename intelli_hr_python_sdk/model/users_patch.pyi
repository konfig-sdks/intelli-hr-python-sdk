...
class UsersPatch(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["isEnabled", "username", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["isEnabled", "username", ], str]):
