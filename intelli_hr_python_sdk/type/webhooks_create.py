...
class RequiredWebhooksCreate(TypedDict):
...
class OptionalWebhooksCreate(TypedDict, total=False):
...
class WebhooksCreate(RequiredWebhooksCreate, OptionalWebhooksCreate):
    pass
