...
class RequiredJobEndRemoveResponseDataJobBusinessUnit(TypedDict):
    pass

class OptionalJobEndRemoveResponseDataJobBusinessUnit(TypedDict, total=False):
...
class JobEndRemoveResponseDataJobBusinessUnit(RequiredJobEndRemoveResponseDataJobBusinessUnit, OptionalJobEndRemoveResponseDataJobBusinessUnit):
    pass
