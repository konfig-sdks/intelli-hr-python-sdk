...
class RequiredLeaveUpdateResponseDataPerson(TypedDict):
    pass

class OptionalLeaveUpdateResponseDataPerson(TypedDict, total=False):
...
class LeaveUpdateResponseDataPerson(RequiredLeaveUpdateResponseDataPerson, OptionalLeaveUpdateResponseDataPerson):
    pass
