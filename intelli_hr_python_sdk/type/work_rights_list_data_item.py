...
class RequiredWorkRightsListDataItem(TypedDict):
    pass

class OptionalWorkRightsListDataItem(TypedDict, total=False):
...
class WorkRightsListDataItem(RequiredWorkRightsListDataItem, OptionalWorkRightsListDataItem):
    pass
