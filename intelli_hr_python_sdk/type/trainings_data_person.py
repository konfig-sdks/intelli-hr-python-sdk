...
class RequiredTrainingsDataPerson(TypedDict):
    pass

class OptionalTrainingsDataPerson(TypedDict, total=False):
...
class TrainingsDataPerson(RequiredTrainingsDataPerson, OptionalTrainingsDataPerson):
    pass
