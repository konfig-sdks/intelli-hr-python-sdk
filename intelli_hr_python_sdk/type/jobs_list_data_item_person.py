...
class RequiredJobsListDataItemPerson(TypedDict):
    pass

class OptionalJobsListDataItemPerson(TypedDict, total=False):
...
class JobsListDataItemPerson(RequiredJobsListDataItemPerson, OptionalJobsListDataItemPerson):
    pass
