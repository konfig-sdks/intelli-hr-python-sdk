...
class RequiredBusinessEntitiesData(TypedDict):
    pass

class OptionalBusinessEntitiesData(TypedDict, total=False):
...
class BusinessEntitiesData(RequiredBusinessEntitiesData, OptionalBusinessEntitiesData):
    pass
