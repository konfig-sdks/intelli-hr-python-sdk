...
class RequiredJobCreateRequestWorkType(TypedDict):
    pass

class OptionalJobCreateRequestWorkType(TypedDict, total=False):
...
class JobCreateRequestWorkType(RequiredJobCreateRequestWorkType, OptionalJobCreateRequestWorkType):
    pass
