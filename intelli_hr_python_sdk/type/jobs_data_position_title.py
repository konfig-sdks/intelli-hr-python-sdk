...
class RequiredJobsDataPositionTitle(TypedDict):
    pass

class OptionalJobsDataPositionTitle(TypedDict, total=False):
...
class JobsDataPositionTitle(RequiredJobsDataPositionTitle, OptionalJobsDataPositionTitle):
    pass
