...
class RequiredJobCreateRequestPerson(TypedDict):
    pass

class OptionalJobCreateRequestPerson(TypedDict, total=False):
...
class JobCreateRequestPerson(RequiredJobCreateRequestPerson, OptionalJobCreateRequestPerson):
    pass
