...
class RequiredJobEndRemoveResponseDataJobPositionTitle(TypedDict):
    pass

class OptionalJobEndRemoveResponseDataJobPositionTitle(TypedDict, total=False):
...
class JobEndRemoveResponseDataJobPositionTitle(RequiredJobEndRemoveResponseDataJobPositionTitle, OptionalJobEndRemoveResponseDataJobPositionTitle):
    pass
