...
class RequiredJobEndPatchResponseDataJobRemunerationScheduleEmploymentCondition(TypedDict):
    pass

class OptionalJobEndPatchResponseDataJobRemunerationScheduleEmploymentCondition(TypedDict, total=False):
...
class JobEndPatchResponseDataJobRemunerationScheduleEmploymentCondition(RequiredJobEndPatchResponseDataJobRemunerationScheduleEmploymentCondition, OptionalJobEndPatchResponseDataJobRemunerationScheduleEmploymentCondition):
    pass
