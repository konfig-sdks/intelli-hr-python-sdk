...
class RequiredJobCreateResponseDataLocation(TypedDict):
    pass

class OptionalJobCreateResponseDataLocation(TypedDict, total=False):
...
class JobCreateResponseDataLocation(RequiredJobCreateResponseDataLocation, OptionalJobCreateResponseDataLocation):
    pass
