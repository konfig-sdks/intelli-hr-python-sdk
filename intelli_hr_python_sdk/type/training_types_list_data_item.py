...
class RequiredTrainingTypesListDataItem(TypedDict):
    pass

class OptionalTrainingTypesListDataItem(TypedDict, total=False):
...
class TrainingTypesListDataItem(RequiredTrainingTypesListDataItem, OptionalTrainingTypesListDataItem):
    pass
