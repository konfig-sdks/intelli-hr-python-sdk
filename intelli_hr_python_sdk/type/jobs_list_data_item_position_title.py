...
class RequiredJobsListDataItemPositionTitle(TypedDict):
    pass

class OptionalJobsListDataItemPositionTitle(TypedDict, total=False):
...
class JobsListDataItemPositionTitle(RequiredJobsListDataItemPositionTitle, OptionalJobsListDataItemPositionTitle):
    pass
