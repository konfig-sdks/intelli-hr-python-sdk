...
from intelli_hr_python_sdk.type.job_end_patch_response_data_job_remuneration_schedule_additions import JobEndPatchResponseDataJobRemunerationScheduleAdditions
from intelli_hr_python_sdk.type.job_end_patch_response_data_job_remuneration_schedule_additions_to_total import JobEndPatchResponseDataJobRemunerationScheduleAdditionsToTotal
from intelli_hr_python_sdk.type.job_end_patch_response_data_job_remuneration_schedule_breakdowns import JobEndPatchResponseDataJobRemunerationScheduleBreakdowns
from intelli_hr_python_sdk.type.job_end_patch_response_data_job_remuneration_schedule_deductions import JobEndPatchResponseDataJobRemunerationScheduleDeductions
from intelli_hr_python_sdk.type.job_end_patch_response_data_job_remuneration_schedule_employment_condition import JobEndPatchResponseDataJobRemunerationScheduleEmploymentCondition

class RequiredJobEndPatchResponseDataJobRemunerationSchedule(TypedDict):
    pass

class OptionalJobEndPatchResponseDataJobRemunerationSchedule(TypedDict, total=False):
    ...
    additions: JobEndPatchResponseDataJobRemunerationScheduleAdditions

    # WARNING: This property is deprecated
    deductions: JobEndPatchResponseDataJobRemunerationScheduleDeductions

    additionsToTotal: JobEndPatchResponseDataJobRemunerationScheduleAdditionsToTotal

    breakdowns: JobEndPatchResponseDataJobRemunerationScheduleBreakdowns

    # The custom field values for this Remuneration Schedule
    customFields: CustomFieldsResponse

class JobEndPatchResponseDataJobRemunerationSchedule(RequiredJobEndPatchResponseDataJobRemunerationSchedule, OptionalJobEndPatchResponseDataJobRemunerationSchedule):
    pass
