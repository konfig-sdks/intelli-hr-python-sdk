...
class RequiredJobCreateResponseDataBusinessUnit(TypedDict):
    pass

class OptionalJobCreateResponseDataBusinessUnit(TypedDict, total=False):
...
class JobCreateResponseDataBusinessUnit(RequiredJobCreateResponseDataBusinessUnit, OptionalJobCreateResponseDataBusinessUnit):
    pass
