...
class RequiredTrainingsPatchRequestPerson(TypedDict):
    pass

class OptionalTrainingsPatchRequestPerson(TypedDict, total=False):
...
class TrainingsPatchRequestPerson(RequiredTrainingsPatchRequestPerson, OptionalTrainingsPatchRequestPerson):
    pass
