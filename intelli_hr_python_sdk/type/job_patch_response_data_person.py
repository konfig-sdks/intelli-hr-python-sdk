...
class RequiredJobPatchResponseDataPerson(TypedDict):
    pass

class OptionalJobPatchResponseDataPerson(TypedDict, total=False):
...
class JobPatchResponseDataPerson(RequiredJobPatchResponseDataPerson, OptionalJobPatchResponseDataPerson):
    pass
