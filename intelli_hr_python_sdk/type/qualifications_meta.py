...
class RequiredQualificationsMeta(TypedDict):
    pass

class OptionalQualificationsMeta(TypedDict, total=False):
...
class QualificationsMeta(RequiredQualificationsMeta, OptionalQualificationsMeta):
    pass
