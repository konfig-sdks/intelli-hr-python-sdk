...
class RequiredJobPatchResponseDataPositionTitle(TypedDict):
    pass

class OptionalJobPatchResponseDataPositionTitle(TypedDict, total=False):
...
class JobPatchResponseDataPositionTitle(RequiredJobPatchResponseDataPositionTitle, OptionalJobPatchResponseDataPositionTitle):
    pass
