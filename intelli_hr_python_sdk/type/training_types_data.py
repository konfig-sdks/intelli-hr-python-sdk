...
class RequiredTrainingTypesData(TypedDict):
    pass

class OptionalTrainingTypesData(TypedDict, total=False):
...
class TrainingTypesData(RequiredTrainingTypesData, OptionalTrainingTypesData):
    pass
