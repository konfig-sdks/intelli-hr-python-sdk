...
class RequiredJobEndPatchResponseDataJobBusinessUnit(TypedDict):
    pass

class OptionalJobEndPatchResponseDataJobBusinessUnit(TypedDict, total=False):
...
class JobEndPatchResponseDataJobBusinessUnit(RequiredJobEndPatchResponseDataJobBusinessUnit, OptionalJobEndPatchResponseDataJobBusinessUnit):
    pass
