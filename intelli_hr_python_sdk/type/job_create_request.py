...
class RequiredJobCreateRequest(TypedDict):
...
class OptionalJobCreateRequest(TypedDict, total=False):
    ...
    customFields: JobCreateRequestCustomFields

class JobCreateRequest(RequiredJobCreateRequest, OptionalJobCreateRequest):
    pass
