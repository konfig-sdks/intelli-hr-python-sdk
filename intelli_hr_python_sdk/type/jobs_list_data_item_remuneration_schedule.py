...
from intelli_hr_python_sdk.type.jobs_list_data_item_remuneration_schedule_additions import JobsListDataItemRemunerationScheduleAdditions
from intelli_hr_python_sdk.type.jobs_list_data_item_remuneration_schedule_additions_to_total import JobsListDataItemRemunerationScheduleAdditionsToTotal
from intelli_hr_python_sdk.type.jobs_list_data_item_remuneration_schedule_breakdowns import JobsListDataItemRemunerationScheduleBreakdowns
from intelli_hr_python_sdk.type.jobs_list_data_item_remuneration_schedule_deductions import JobsListDataItemRemunerationScheduleDeductions
from intelli_hr_python_sdk.type.jobs_list_data_item_remuneration_schedule_employment_condition import JobsListDataItemRemunerationScheduleEmploymentCondition

class RequiredJobsListDataItemRemunerationSchedule(TypedDict):
    pass

class OptionalJobsListDataItemRemunerationSchedule(TypedDict, total=False):
    ...
    employmentCondition: JobsListDataItemRemunerationScheduleEmploymentCondition

    additions: JobsListDataItemRemunerationScheduleAdditions

    # WARNING: This property is deprecated
    deductions: JobsListDataItemRemunerationScheduleDeductions

    additionsToTotal: JobsListDataItemRemunerationScheduleAdditionsToTotal

    breakdowns: JobsListDataItemRemunerationScheduleBreakdowns

    # The custom field values for this Remuneration Schedule
    customFields: CustomFieldsResponse

class JobsListDataItemRemunerationSchedule(RequiredJobsListDataItemRemunerationSchedule, OptionalJobsListDataItemRemunerationSchedule):
    pass
