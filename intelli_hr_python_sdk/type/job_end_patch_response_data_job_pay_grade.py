...
class RequiredJobEndPatchResponseDataJobPayGrade(TypedDict):
    pass

class OptionalJobEndPatchResponseDataJobPayGrade(TypedDict, total=False):
...
class JobEndPatchResponseDataJobPayGrade(RequiredJobEndPatchResponseDataJobPayGrade, OptionalJobEndPatchResponseDataJobPayGrade):
    pass
