...
class RequiredJobsDataLocation(TypedDict):
    pass

class OptionalJobsDataLocation(TypedDict, total=False):
...
class JobsDataLocation(RequiredJobsDataLocation, OptionalJobsDataLocation):
    pass
