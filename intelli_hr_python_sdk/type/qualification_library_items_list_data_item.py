...
from intelli_hr_python_sdk.type.qualification_library_items_list_data_item_qualification_type import QualificationLibraryItemsListDataItemQualificationType

class RequiredQualificationLibraryItemsListDataItem(TypedDict):
    pass

class OptionalQualificationLibraryItemsListDataItem(TypedDict, total=False):
    ...
    qualificationType: QualificationLibraryItemsListDataItemQualificationType
...
class QualificationLibraryItemsListDataItem(RequiredQualificationLibraryItemsListDataItem, OptionalQualificationLibraryItemsListDataItem):
    pass
