...
class RequiredWebhookEventsData(TypedDict):
    pass

class OptionalWebhookEventsData(TypedDict, total=False):
...
class WebhookEventsData(RequiredWebhookEventsData, OptionalWebhookEventsData):
    pass
