...
class RequiredPositionTitlesData(TypedDict):
    pass

class OptionalPositionTitlesData(TypedDict, total=False):
...
class PositionTitlesData(RequiredPositionTitlesData, OptionalPositionTitlesData):
    pass
