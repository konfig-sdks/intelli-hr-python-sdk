...
class RequiredJobsListDataItemEstablishment(TypedDict):
    pass

class OptionalJobsListDataItemEstablishment(TypedDict, total=False):
...
class JobsListDataItemEstablishment(RequiredJobsListDataItemEstablishment, OptionalJobsListDataItemEstablishment):
    pass
