...
class RequiredJobsListDataItemBusinessUnit(TypedDict):
    pass

class OptionalJobsListDataItemBusinessUnit(TypedDict, total=False):
...
class JobsListDataItemBusinessUnit(RequiredJobsListDataItemBusinessUnit, OptionalJobsListDataItemBusinessUnit):
    pass
