...
class RequiredBusinessUnitsData(TypedDict):
    pass

class OptionalBusinessUnitsData(TypedDict, total=False):
...
class BusinessUnitsData(RequiredBusinessUnitsData, OptionalBusinessUnitsData):
    pass
