...
class RequiredPayGradeCreateRequestEmploymentCondition(TypedDict):
    pass

class OptionalPayGradeCreateRequestEmploymentCondition(TypedDict, total=False):
...
class PayGradeCreateRequestEmploymentCondition(RequiredPayGradeCreateRequestEmploymentCondition, OptionalPayGradeCreateRequestEmploymentCondition):
    pass
