...
class RequiredLeaveCreateResponseMeta(TypedDict):
    pass

class OptionalLeaveCreateResponseMeta(TypedDict, total=False):
...
class LeaveCreateResponseMeta(RequiredLeaveCreateResponseMeta, OptionalLeaveCreateResponseMeta):
    pass
