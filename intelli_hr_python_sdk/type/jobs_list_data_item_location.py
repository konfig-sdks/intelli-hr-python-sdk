...
class RequiredJobsListDataItemLocation(TypedDict):
    pass

class OptionalJobsListDataItemLocation(TypedDict, total=False):
...
class JobsListDataItemLocation(RequiredJobsListDataItemLocation, OptionalJobsListDataItemLocation):
    pass
