...
class RequiredJobEndRemoveResponseDataJobBusinessEntity(TypedDict):
    pass

class OptionalJobEndRemoveResponseDataJobBusinessEntity(TypedDict, total=False):
...
class JobEndRemoveResponseDataJobBusinessEntity(RequiredJobEndRemoveResponseDataJobBusinessEntity, OptionalJobEndRemoveResponseDataJobBusinessEntity):
    pass
