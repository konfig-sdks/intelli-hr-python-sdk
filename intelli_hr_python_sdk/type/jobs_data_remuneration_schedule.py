...
from intelli_hr_python_sdk.type.jobs_data_remuneration_schedule_additions import JobsDataRemunerationScheduleAdditions
from intelli_hr_python_sdk.type.jobs_data_remuneration_schedule_additions_to_total import JobsDataRemunerationScheduleAdditionsToTotal
from intelli_hr_python_sdk.type.jobs_data_remuneration_schedule_breakdowns import JobsDataRemunerationScheduleBreakdowns
from intelli_hr_python_sdk.type.jobs_data_remuneration_schedule_deductions import JobsDataRemunerationScheduleDeductions
from intelli_hr_python_sdk.type.jobs_data_remuneration_schedule_employment_condition import JobsDataRemunerationScheduleEmploymentCondition

class RequiredJobsDataRemunerationSchedule(TypedDict):
    pass

class OptionalJobsDataRemunerationSchedule(TypedDict, total=False):
    ...
    employmentCondition: JobsDataRemunerationScheduleEmploymentCondition

    additions: JobsDataRemunerationScheduleAdditions

    # WARNING: This property is deprecated
    deductions: JobsDataRemunerationScheduleDeductions

    additionsToTotal: JobsDataRemunerationScheduleAdditionsToTotal

    breakdowns: JobsDataRemunerationScheduleBreakdowns

    # The custom field values for this Remuneration Schedule
    customFields: CustomFieldsResponse

class JobsDataRemunerationSchedule(RequiredJobsDataRemunerationSchedule, OptionalJobsDataRemunerationSchedule):
    pass
