...
class RequiredWorkflowsPatchResponseDataWorkflow(TypedDict):
    pass

class OptionalWorkflowsPatchResponseDataWorkflow(TypedDict, total=False):
...
class WorkflowsPatchResponseDataWorkflow(RequiredWorkflowsPatchResponseDataWorkflow, OptionalWorkflowsPatchResponseDataWorkflow):
    pass
