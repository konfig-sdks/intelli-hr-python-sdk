...
class RequiredPersonIdListDataItemSkillDiscipline(TypedDict):
    pass

class OptionalPersonIdListDataItemSkillDiscipline(TypedDict, total=False):
...
class PersonIdListDataItemSkillDiscipline(RequiredPersonIdListDataItemSkillDiscipline, OptionalPersonIdListDataItemSkillDiscipline):
    pass
