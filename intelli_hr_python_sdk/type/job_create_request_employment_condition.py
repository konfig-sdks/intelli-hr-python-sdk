...
class RequiredJobCreateRequestEmploymentCondition(TypedDict):
    pass

class OptionalJobCreateRequestEmploymentCondition(TypedDict, total=False):
...
class JobCreateRequestEmploymentCondition(RequiredJobCreateRequestEmploymentCondition, OptionalJobCreateRequestEmploymentCondition):
    pass
