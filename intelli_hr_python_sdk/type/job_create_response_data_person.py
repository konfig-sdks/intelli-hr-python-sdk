...
class RequiredJobCreateResponseDataPerson(TypedDict):
    pass

class OptionalJobCreateResponseDataPerson(TypedDict, total=False):
...
class JobCreateResponseDataPerson(RequiredJobCreateResponseDataPerson, OptionalJobCreateResponseDataPerson):
    pass
