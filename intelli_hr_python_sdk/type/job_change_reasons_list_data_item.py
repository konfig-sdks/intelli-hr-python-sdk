...
class RequiredJobChangeReasonsListDataItem(TypedDict):
    pass

class OptionalJobChangeReasonsListDataItem(TypedDict, total=False):
...
class JobChangeReasonsListDataItem(RequiredJobChangeReasonsListDataItem, OptionalJobChangeReasonsListDataItem):
    pass
