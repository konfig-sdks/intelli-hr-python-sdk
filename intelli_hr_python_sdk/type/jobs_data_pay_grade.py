...
class RequiredJobsDataPayGrade(TypedDict):
    pass

class OptionalJobsDataPayGrade(TypedDict, total=False):
...
class JobsDataPayGrade(RequiredJobsDataPayGrade, OptionalJobsDataPayGrade):
    pass
