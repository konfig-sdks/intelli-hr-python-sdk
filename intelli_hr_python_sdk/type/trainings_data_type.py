...
class RequiredTrainingsDataType(TypedDict):
    pass

class OptionalTrainingsDataType(TypedDict, total=False):
...
class TrainingsDataType(RequiredTrainingsDataType, OptionalTrainingsDataType):
    pass
