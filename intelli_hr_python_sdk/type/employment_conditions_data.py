...
class RequiredEmploymentConditionsData(TypedDict):
    pass

class OptionalEmploymentConditionsData(TypedDict, total=False):
...
class EmploymentConditionsData(RequiredEmploymentConditionsData, OptionalEmploymentConditionsData):
    pass
