...
class RequiredJobEndPatchResponseDataJobPerson(TypedDict):
    pass

class OptionalJobEndPatchResponseDataJobPerson(TypedDict, total=False):
...
class JobEndPatchResponseDataJobPerson(RequiredJobEndPatchResponseDataJobPerson, OptionalJobEndPatchResponseDataJobPerson):
    pass
