...
class RequiredTrainingsDataProvider(TypedDict):
    pass

class OptionalTrainingsDataProvider(TypedDict, total=False):
...
class TrainingsDataProvider(RequiredTrainingsDataProvider, OptionalTrainingsDataProvider):
    pass
