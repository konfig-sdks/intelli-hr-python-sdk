...
class RequiredPermissionGroupsListDataItem(TypedDict):
    pass

class OptionalPermissionGroupsListDataItem(TypedDict, total=False):
...
class PermissionGroupsListDataItem(RequiredPermissionGroupsListDataItem, OptionalPermissionGroupsListDataItem):
    pass
