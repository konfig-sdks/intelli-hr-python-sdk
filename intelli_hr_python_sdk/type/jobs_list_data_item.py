...
from intelli_hr_python_sdk.type.jobs_list_data_item_business_entity import JobsListDataItemBusinessEntity
from intelli_hr_python_sdk.type.jobs_list_data_item_business_unit import JobsListDataItemBusinessUnit
from intelli_hr_python_sdk.type.jobs_list_data_item_comments import JobsListDataItemComments
from intelli_hr_python_sdk.type.jobs_list_data_item_establishment import JobsListDataItemEstablishment
from intelli_hr_python_sdk.type.jobs_list_data_item_location import JobsListDataItemLocation
from intelli_hr_python_sdk.type.jobs_list_data_item_pay_grade import JobsListDataItemPayGrade
from intelli_hr_python_sdk.type.jobs_list_data_item_person import JobsListDataItemPerson
from intelli_hr_python_sdk.type.jobs_list_data_item_position_title import JobsListDataItemPositionTitle
from intelli_hr_python_sdk.type.jobs_list_data_item_recruitment import JobsListDataItemRecruitment
from intelli_hr_python_sdk.type.jobs_list_data_item_remuneration_schedule import JobsListDataItemRemunerationSchedule

class RequiredJobsListDataItem(TypedDict):
    pass

class OptionalJobsListDataItem(TypedDict, total=False):
    # The identifier string for the [Job](https://developers.intellihr.io/docs/v1/).
    id: str

    person: JobsListDataItemPerson

    recruitment: JobsListDataItemRecruitment
    ...
    location: JobsListDataItemLocation

    payGrade: JobsListDataItemPayGrade

    businessUnit: JobsListDataItemBusinessUnit

    businessEntity: JobsListDataItemBusinessEntity

    establishment: JobsListDataItemEstablishment
    ...
    remunerationSchedule: JobsListDataItemRemunerationSchedule

    # The name of this [Job](https://developers.intellihr.io/docs/v1/).
    name: str

    positionTitle: JobsListDataItemPositionTitle
    ...
    comments: JobsListDataItemComments
...
class JobsListDataItem(RequiredJobsListDataItem, OptionalJobsListDataItem):
    pass
