...
from intelli_hr_python_sdk.type.pay_grades_data_pay_grade_values import PayGradesDataPayGradeValues

class RequiredPayGradesData(TypedDict):
    pass

class OptionalPayGradesData(TypedDict, total=False):
    ...
    payGradeValues: PayGradesDataPayGradeValues
...
class PayGradesData(RequiredPayGradesData, OptionalPayGradesData):
    pass
