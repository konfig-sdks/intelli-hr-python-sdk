...
class RequiredPermissionGroupsMeta(TypedDict):
    pass

class OptionalPermissionGroupsMeta(TypedDict, total=False):
...
class PermissionGroupsMeta(RequiredPermissionGroupsMeta, OptionalPermissionGroupsMeta):
    pass
