...
class RequiredUsersDataPerson(TypedDict):
    pass

class OptionalUsersDataPerson(TypedDict, total=False):
...
class UsersDataPerson(RequiredUsersDataPerson, OptionalUsersDataPerson):
    pass
