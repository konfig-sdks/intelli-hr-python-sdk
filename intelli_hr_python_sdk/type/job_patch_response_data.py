...
from intelli_hr_python_sdk.type.job_patch_response_data_business_entity import JobPatchResponseDataBusinessEntity
from intelli_hr_python_sdk.type.job_patch_response_data_business_unit import JobPatchResponseDataBusinessUnit
from intelli_hr_python_sdk.type.job_patch_response_data_comments import JobPatchResponseDataComments
from intelli_hr_python_sdk.type.job_patch_response_data_establishment import JobPatchResponseDataEstablishment
from intelli_hr_python_sdk.type.job_patch_response_data_location import JobPatchResponseDataLocation
from intelli_hr_python_sdk.type.job_patch_response_data_pay_grade import JobPatchResponseDataPayGrade
from intelli_hr_python_sdk.type.job_patch_response_data_person import JobPatchResponseDataPerson
from intelli_hr_python_sdk.type.job_patch_response_data_position_title import JobPatchResponseDataPositionTitle
from intelli_hr_python_sdk.type.job_patch_response_data_recruitment import JobPatchResponseDataRecruitment
from intelli_hr_python_sdk.type.job_patch_response_data_remuneration_schedule import JobPatchResponseDataRemunerationSchedule

class RequiredJobPatchResponseData(TypedDict):
    pass

class OptionalJobPatchResponseData(TypedDict, total=False):
    # The identifier string for the [Job](https://developers.intellihr.io/docs/v1/).
    id: str

    person: JobPatchResponseDataPerson

    recruitment: JobPatchResponseDataRecruitment
    ...
    location: JobPatchResponseDataLocation

    payGrade: JobPatchResponseDataPayGrade

    businessUnit: JobPatchResponseDataBusinessUnit

    businessEntity: JobPatchResponseDataBusinessEntity

    establishment: JobPatchResponseDataEstablishment
    ...
    remunerationSchedule: JobPatchResponseDataRemunerationSchedule

    # The name of this [Job](https://developers.intellihr.io/docs/v1/).
    name: str

    positionTitle: JobPatchResponseDataPositionTitle
    ...
    comments: JobPatchResponseDataComments
...
class JobPatchResponseData(RequiredJobPatchResponseData, OptionalJobPatchResponseData):
    pass
