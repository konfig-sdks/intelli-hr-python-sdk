...
class RequiredJobPatchRequestPayGrade(TypedDict):
    pass

class OptionalJobPatchRequestPayGrade(TypedDict, total=False):
...
class JobPatchRequestPayGrade(RequiredJobPatchRequestPayGrade, OptionalJobPatchRequestPayGrade):
    pass
