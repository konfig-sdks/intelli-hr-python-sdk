...
class RequiredBusinessEntitiesMeta(TypedDict):
    pass

class OptionalBusinessEntitiesMeta(TypedDict, total=False):
...
class BusinessEntitiesMeta(RequiredBusinessEntitiesMeta, OptionalBusinessEntitiesMeta):
    pass
