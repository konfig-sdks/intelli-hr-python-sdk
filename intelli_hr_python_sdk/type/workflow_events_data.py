...
from intelli_hr_python_sdk.type.workflow_events_data_workflows import WorkflowEventsDataWorkflows

class RequiredWorkflowEventsData(TypedDict):
    pass

class OptionalWorkflowEventsData(TypedDict, total=False):
    ...
    workflows: WorkflowEventsDataWorkflows

class WorkflowEventsData(RequiredWorkflowEventsData, OptionalWorkflowEventsData):
    pass
