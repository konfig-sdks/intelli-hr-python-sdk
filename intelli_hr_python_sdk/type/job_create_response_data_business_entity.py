...
class RequiredJobCreateResponseDataBusinessEntity(TypedDict):
    pass

class OptionalJobCreateResponseDataBusinessEntity(TypedDict, total=False):
...
class JobCreateResponseDataBusinessEntity(RequiredJobCreateResponseDataBusinessEntity, OptionalJobCreateResponseDataBusinessEntity):
    pass
