...
class RequiredPeopleDocumentsCreateRequest(TypedDict):
...
class OptionalPeopleDocumentsCreateRequest(TypedDict, total=False):
    pass

class PeopleDocumentsCreateRequest(RequiredPeopleDocumentsCreateRequest, OptionalPeopleDocumentsCreateRequest):
    pass
