...
class RequiredTrainingsCreateRequestProvider(TypedDict):
    pass

class OptionalTrainingsCreateRequestProvider(TypedDict, total=False):
...
class TrainingsCreateRequestProvider(RequiredTrainingsCreateRequestProvider, OptionalTrainingsCreateRequestProvider):
    pass
