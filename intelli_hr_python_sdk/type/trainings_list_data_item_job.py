...
class RequiredTrainingsListDataItemJob(TypedDict):
    pass

class OptionalTrainingsListDataItemJob(TypedDict, total=False):
...
class TrainingsListDataItemJob(RequiredTrainingsListDataItemJob, OptionalTrainingsListDataItemJob):
    pass
