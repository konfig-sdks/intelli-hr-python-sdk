...
class RequiredJobEndRemoveResponseDataJobLocation(TypedDict):
    pass

class OptionalJobEndRemoveResponseDataJobLocation(TypedDict, total=False):
...
class JobEndRemoveResponseDataJobLocation(RequiredJobEndRemoveResponseDataJobLocation, OptionalJobEndRemoveResponseDataJobLocation):
    pass
