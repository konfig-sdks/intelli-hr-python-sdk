...
class RequiredPayGradeUpdateRequestEmploymentCondition(TypedDict):
    pass

class OptionalPayGradeUpdateRequestEmploymentCondition(TypedDict, total=False):
...
class PayGradeUpdateRequestEmploymentCondition(RequiredPayGradeUpdateRequestEmploymentCondition, OptionalPayGradeUpdateRequestEmploymentCondition):
    pass
