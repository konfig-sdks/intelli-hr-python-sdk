...
class RequiredSkillsCreateRequest(TypedDict):
    ...
    skillDisciplineId: str

class OptionalSkillsCreateRequest(TypedDict, total=False):
    pass

class SkillsCreateRequest(RequiredSkillsCreateRequest, OptionalSkillsCreateRequest):
    pass
