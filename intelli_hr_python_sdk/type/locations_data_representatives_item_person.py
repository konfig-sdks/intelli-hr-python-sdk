...
class RequiredLocationsDataRepresentativesItemPerson(TypedDict):
    pass

class OptionalLocationsDataRepresentativesItemPerson(TypedDict, total=False):
...
class LocationsDataRepresentativesItemPerson(RequiredLocationsDataRepresentativesItemPerson, OptionalLocationsDataRepresentativesItemPerson):
    pass
