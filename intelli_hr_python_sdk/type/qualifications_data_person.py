...
class RequiredQualificationsDataPerson(TypedDict):
    pass

class OptionalQualificationsDataPerson(TypedDict, total=False):
...
class QualificationsDataPerson(RequiredQualificationsDataPerson, OptionalQualificationsDataPerson):
    pass
