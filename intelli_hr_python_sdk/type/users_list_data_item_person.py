...
class RequiredUsersListDataItemPerson(TypedDict):
    pass

class OptionalUsersListDataItemPerson(TypedDict, total=False):
...
class UsersListDataItemPerson(RequiredUsersListDataItemPerson, OptionalUsersListDataItemPerson):
    pass
