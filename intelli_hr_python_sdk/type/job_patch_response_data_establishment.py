...
class RequiredJobPatchResponseDataEstablishment(TypedDict):
    pass

class OptionalJobPatchResponseDataEstablishment(TypedDict, total=False):
...
class JobPatchResponseDataEstablishment(RequiredJobPatchResponseDataEstablishment, OptionalJobPatchResponseDataEstablishment):
    pass
