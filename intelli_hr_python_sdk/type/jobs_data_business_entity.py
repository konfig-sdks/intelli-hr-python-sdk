...
class RequiredJobsDataBusinessEntity(TypedDict):
    pass

class OptionalJobsDataBusinessEntity(TypedDict, total=False):
...
class JobsDataBusinessEntity(RequiredJobsDataBusinessEntity, OptionalJobsDataBusinessEntity):
    pass
