...
class RequiredJobPatchResponseDataLocation(TypedDict):
    pass

class OptionalJobPatchResponseDataLocation(TypedDict, total=False):
...
class JobPatchResponseDataLocation(RequiredJobPatchResponseDataLocation, OptionalJobPatchResponseDataLocation):
    pass
