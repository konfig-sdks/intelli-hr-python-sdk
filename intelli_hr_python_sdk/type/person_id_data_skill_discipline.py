...
class RequiredPersonIdDataSkillDiscipline(TypedDict):
    pass

class OptionalPersonIdDataSkillDiscipline(TypedDict, total=False):
...
class PersonIdDataSkillDiscipline(RequiredPersonIdDataSkillDiscipline, OptionalPersonIdDataSkillDiscipline):
    pass
