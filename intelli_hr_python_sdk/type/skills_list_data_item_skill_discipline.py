...
class RequiredSkillsListDataItemSkillDiscipline(TypedDict):
    pass

class OptionalSkillsListDataItemSkillDiscipline(TypedDict, total=False):
...
class SkillsListDataItemSkillDiscipline(RequiredSkillsListDataItemSkillDiscipline, OptionalSkillsListDataItemSkillDiscipline):
    pass
