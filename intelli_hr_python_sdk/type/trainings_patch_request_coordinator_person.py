...
class RequiredTrainingsPatchRequestCoordinatorPerson(TypedDict):
    pass

class OptionalTrainingsPatchRequestCoordinatorPerson(TypedDict, total=False):
...
class TrainingsPatchRequestCoordinatorPerson(RequiredTrainingsPatchRequestCoordinatorPerson, OptionalTrainingsPatchRequestCoordinatorPerson):
    pass
