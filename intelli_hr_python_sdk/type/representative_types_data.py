...
class RequiredRepresentativeTypesData(TypedDict):
    pass

class OptionalRepresentativeTypesData(TypedDict, total=False):
...
class RepresentativeTypesData(RequiredRepresentativeTypesData, OptionalRepresentativeTypesData):
    pass
