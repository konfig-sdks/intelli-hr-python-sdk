...
class RequiredLeaveCreateResponseDataPerson(TypedDict):
    pass

class OptionalLeaveCreateResponseDataPerson(TypedDict, total=False):
...
class LeaveCreateResponseDataPerson(RequiredLeaveCreateResponseDataPerson, OptionalLeaveCreateResponseDataPerson):
    pass
