...
class RequiredJobEndPatchResponseDataJobBusinessEntity(TypedDict):
    pass

class OptionalJobEndPatchResponseDataJobBusinessEntity(TypedDict, total=False):
...
class JobEndPatchResponseDataJobBusinessEntity(RequiredJobEndPatchResponseDataJobBusinessEntity, OptionalJobEndPatchResponseDataJobBusinessEntity):
    pass
