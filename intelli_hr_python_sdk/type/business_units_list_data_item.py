...
class RequiredBusinessUnitsListDataItem(TypedDict):
    pass

class OptionalBusinessUnitsListDataItem(TypedDict, total=False):
...
class BusinessUnitsListDataItem(RequiredBusinessUnitsListDataItem, OptionalBusinessUnitsListDataItem):
    pass
