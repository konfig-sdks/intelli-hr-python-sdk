...
class RequiredWebhooksListDataItemWebhookEvent(TypedDict):
    pass

class OptionalWebhooksListDataItemWebhookEvent(TypedDict, total=False):
...
class WebhooksListDataItemWebhookEvent(RequiredWebhooksListDataItemWebhookEvent, OptionalWebhooksListDataItemWebhookEvent):
    pass
