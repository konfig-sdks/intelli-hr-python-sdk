...
class RequiredUsersCreatePerson(TypedDict):
    pass

class OptionalUsersCreatePerson(TypedDict, total=False):
...
class UsersCreatePerson(RequiredUsersCreatePerson, OptionalUsersCreatePerson):
    pass
