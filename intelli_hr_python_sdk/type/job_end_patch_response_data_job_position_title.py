...
class RequiredJobEndPatchResponseDataJobPositionTitle(TypedDict):
    pass

class OptionalJobEndPatchResponseDataJobPositionTitle(TypedDict, total=False):
...
class JobEndPatchResponseDataJobPositionTitle(RequiredJobEndPatchResponseDataJobPositionTitle, OptionalJobEndPatchResponseDataJobPositionTitle):
    pass
