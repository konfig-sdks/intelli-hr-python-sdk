...
class RequiredJobPatchResponseDataBusinessUnit(TypedDict):
    pass

class OptionalJobPatchResponseDataBusinessUnit(TypedDict, total=False):
...
class JobPatchResponseDataBusinessUnit(RequiredJobPatchResponseDataBusinessUnit, OptionalJobPatchResponseDataBusinessUnit):
    pass
