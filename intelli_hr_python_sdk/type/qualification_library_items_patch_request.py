...
class RequiredQualificationLibraryItemsPatchRequest(TypedDict):
    pass

class OptionalQualificationLibraryItemsPatchRequest(TypedDict, total=False):
...
class QualificationLibraryItemsPatchRequest(RequiredQualificationLibraryItemsPatchRequest, OptionalQualificationLibraryItemsPatchRequest):
    pass
