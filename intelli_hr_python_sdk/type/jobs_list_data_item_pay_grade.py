...
class RequiredJobsListDataItemPayGrade(TypedDict):
    pass

class OptionalJobsListDataItemPayGrade(TypedDict, total=False):
...
class JobsListDataItemPayGrade(RequiredJobsListDataItemPayGrade, OptionalJobsListDataItemPayGrade):
    pass
