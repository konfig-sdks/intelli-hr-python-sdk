...
from intelli_hr_python_sdk.type.job_end_remove_response_data_job_remuneration_schedule_additions import JobEndRemoveResponseDataJobRemunerationScheduleAdditions
from intelli_hr_python_sdk.type.job_end_remove_response_data_job_remuneration_schedule_additions_to_total import JobEndRemoveResponseDataJobRemunerationScheduleAdditionsToTotal
from intelli_hr_python_sdk.type.job_end_remove_response_data_job_remuneration_schedule_breakdowns import JobEndRemoveResponseDataJobRemunerationScheduleBreakdowns
from intelli_hr_python_sdk.type.job_end_remove_response_data_job_remuneration_schedule_deductions import JobEndRemoveResponseDataJobRemunerationScheduleDeductions
from intelli_hr_python_sdk.type.job_end_remove_response_data_job_remuneration_schedule_employment_condition import JobEndRemoveResponseDataJobRemunerationScheduleEmploymentCondition

class RequiredJobEndRemoveResponseDataJobRemunerationSchedule(TypedDict):
    pass

class OptionalJobEndRemoveResponseDataJobRemunerationSchedule(TypedDict, total=False):
    ...
    additions: JobEndRemoveResponseDataJobRemunerationScheduleAdditions

    # WARNING: This property is deprecated
    deductions: JobEndRemoveResponseDataJobRemunerationScheduleDeductions

    additionsToTotal: JobEndRemoveResponseDataJobRemunerationScheduleAdditionsToTotal

    breakdowns: JobEndRemoveResponseDataJobRemunerationScheduleBreakdowns

    # The custom field values for this Remuneration Schedule
    customFields: CustomFieldsResponse

class JobEndRemoveResponseDataJobRemunerationSchedule(RequiredJobEndRemoveResponseDataJobRemunerationSchedule, OptionalJobEndRemoveResponseDataJobRemunerationSchedule):
    pass
