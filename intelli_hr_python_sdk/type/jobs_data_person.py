...
class RequiredJobsDataPerson(TypedDict):
    pass

class OptionalJobsDataPerson(TypedDict, total=False):
...
class JobsDataPerson(RequiredJobsDataPerson, OptionalJobsDataPerson):
    pass
