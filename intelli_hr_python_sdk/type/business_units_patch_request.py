...
class RequiredBusinessUnitsPatchRequest(TypedDict):
...
class OptionalBusinessUnitsPatchRequest(TypedDict, total=False):
    ...
    customFields: BusinessUnitsPatchRequestCustomFields

class BusinessUnitsPatchRequest(RequiredBusinessUnitsPatchRequest, OptionalBusinessUnitsPatchRequest):
    pass
