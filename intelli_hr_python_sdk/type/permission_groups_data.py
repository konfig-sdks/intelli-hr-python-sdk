...
class RequiredPermissionGroupsData(TypedDict):
    pass

class OptionalPermissionGroupsData(TypedDict, total=False):
...
class PermissionGroupsData(RequiredPermissionGroupsData, OptionalPermissionGroupsData):
    pass
