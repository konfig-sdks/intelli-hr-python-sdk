...
class RequiredSkillsDataSkillDiscipline(TypedDict):
    pass

class OptionalSkillsDataSkillDiscipline(TypedDict, total=False):
...
class SkillsDataSkillDiscipline(RequiredSkillsDataSkillDiscipline, OptionalSkillsDataSkillDiscipline):
    pass
