...
class RequiredJobsListDataItemBusinessEntity(TypedDict):
    pass

class OptionalJobsListDataItemBusinessEntity(TypedDict, total=False):
...
class JobsListDataItemBusinessEntity(RequiredJobsListDataItemBusinessEntity, OptionalJobsListDataItemBusinessEntity):
    pass
