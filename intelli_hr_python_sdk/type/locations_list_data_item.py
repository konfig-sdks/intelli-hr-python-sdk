...
from intelli_hr_python_sdk.type.locations_list_data_item_representatives import LocationsListDataItemRepresentatives

class RequiredLocationsListDataItem(TypedDict):
    pass

class OptionalLocationsListDataItem(TypedDict, total=False):
    ...
    representatives: LocationsListDataItemRepresentatives

    # The custom field values for this [Location](https://developers.intellihr.io/docs/v1/)
    customFields: CustomFieldsResponse

class LocationsListDataItem(RequiredLocationsListDataItem, OptionalLocationsListDataItem):
    pass
