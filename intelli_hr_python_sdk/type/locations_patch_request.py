...
class RequiredLocationsPatchRequest(TypedDict):
    pass

class OptionalLocationsPatchRequest(TypedDict, total=False):
    ...
    customFields: LocationsPatchRequestCustomFields

class LocationsPatchRequest(RequiredLocationsPatchRequest, OptionalLocationsPatchRequest):
    pass
