...
class RequiredTrainingsListDataItemPerson(TypedDict):
    pass

class OptionalTrainingsListDataItemPerson(TypedDict, total=False):
    ...
    employeeNumber: typing.Union[none_type, str]
...
class TrainingsListDataItemPerson(RequiredTrainingsListDataItemPerson, OptionalTrainingsListDataItemPerson):
    pass
