...
class RequiredTrainingsPatchRequestProvider(TypedDict):
    pass

class OptionalTrainingsPatchRequestProvider(TypedDict, total=False):
...
class TrainingsPatchRequestProvider(RequiredTrainingsPatchRequestProvider, OptionalTrainingsPatchRequestProvider):
    pass
