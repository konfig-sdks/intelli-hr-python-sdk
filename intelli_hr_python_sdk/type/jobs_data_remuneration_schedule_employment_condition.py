...
class RequiredJobsDataRemunerationScheduleEmploymentCondition(TypedDict):
    pass

class OptionalJobsDataRemunerationScheduleEmploymentCondition(TypedDict, total=False):
...
class JobsDataRemunerationScheduleEmploymentCondition(RequiredJobsDataRemunerationScheduleEmploymentCondition, OptionalJobsDataRemunerationScheduleEmploymentCondition):
    pass
