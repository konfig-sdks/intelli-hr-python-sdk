...
class RequiredTrainingsListDataItemType(TypedDict):
    pass

class OptionalTrainingsListDataItemType(TypedDict, total=False):
...
class TrainingsListDataItemType(RequiredTrainingsListDataItemType, OptionalTrainingsListDataItemType):
    pass
