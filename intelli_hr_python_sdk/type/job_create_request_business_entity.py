...
class RequiredJobCreateRequestBusinessEntity(TypedDict):
    pass

class OptionalJobCreateRequestBusinessEntity(TypedDict, total=False):
...
class JobCreateRequestBusinessEntity(RequiredJobCreateRequestBusinessEntity, OptionalJobCreateRequestBusinessEntity):
    pass
