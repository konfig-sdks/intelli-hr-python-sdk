...
class RequiredTrainingsCreateRequestCoordinatorPerson(TypedDict):
    pass

class OptionalTrainingsCreateRequestCoordinatorPerson(TypedDict, total=False):
...
class TrainingsCreateRequestCoordinatorPerson(RequiredTrainingsCreateRequestCoordinatorPerson, OptionalTrainingsCreateRequestCoordinatorPerson):
    pass
