...
class RequiredQualificationsListDataItemPerson(TypedDict):
    pass

class OptionalQualificationsListDataItemPerson(TypedDict, total=False):
...
class QualificationsListDataItemPerson(RequiredQualificationsListDataItemPerson, OptionalQualificationsListDataItemPerson):
    pass
