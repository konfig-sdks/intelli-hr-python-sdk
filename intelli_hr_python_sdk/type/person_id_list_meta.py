...
class RequiredPersonIdListMeta(TypedDict):
    pass

class OptionalPersonIdListMeta(TypedDict, total=False):
...
class PersonIdListMeta(RequiredPersonIdListMeta, OptionalPersonIdListMeta):
    pass
