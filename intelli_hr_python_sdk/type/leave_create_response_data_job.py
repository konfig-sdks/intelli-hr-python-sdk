...
class RequiredLeaveCreateResponseDataJob(TypedDict):
    pass

class OptionalLeaveCreateResponseDataJob(TypedDict, total=False):
...
class LeaveCreateResponseDataJob(RequiredLeaveCreateResponseDataJob, OptionalLeaveCreateResponseDataJob):
    pass
