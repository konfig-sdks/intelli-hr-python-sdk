...
class RequiredTrainingsPatchRequestType(TypedDict):
    pass

class OptionalTrainingsPatchRequestType(TypedDict, total=False):
...
class TrainingsPatchRequestType(RequiredTrainingsPatchRequestType, OptionalTrainingsPatchRequestType):
    pass
