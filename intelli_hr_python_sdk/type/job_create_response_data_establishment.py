...
class RequiredJobCreateResponseDataEstablishment(TypedDict):
    pass

class OptionalJobCreateResponseDataEstablishment(TypedDict, total=False):
...
class JobCreateResponseDataEstablishment(RequiredJobCreateResponseDataEstablishment, OptionalJobCreateResponseDataEstablishment):
    pass
