...
class RequiredJobCreateResponseDataPayGrade(TypedDict):
    pass

class OptionalJobCreateResponseDataPayGrade(TypedDict, total=False):
...
class JobCreateResponseDataPayGrade(RequiredJobCreateResponseDataPayGrade, OptionalJobCreateResponseDataPayGrade):
    pass
