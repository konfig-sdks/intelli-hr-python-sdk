...
class RequiredJobEndRemoveResponseDataJobPerson(TypedDict):
    pass

class OptionalJobEndRemoveResponseDataJobPerson(TypedDict, total=False):
...
class JobEndRemoveResponseDataJobPerson(RequiredJobEndRemoveResponseDataJobPerson, OptionalJobEndRemoveResponseDataJobPerson):
    pass
