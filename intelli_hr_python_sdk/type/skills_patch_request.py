...
class RequiredSkillsPatchRequest(TypedDict):
    pass

class OptionalSkillsPatchRequest(TypedDict, total=False):
...
class SkillsPatchRequest(RequiredSkillsPatchRequest, OptionalSkillsPatchRequest):
    pass
