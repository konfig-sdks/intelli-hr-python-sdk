...
class RequiredJobPatchResponseDataBusinessEntity(TypedDict):
    pass

class OptionalJobPatchResponseDataBusinessEntity(TypedDict, total=False):
...
class JobPatchResponseDataBusinessEntity(RequiredJobPatchResponseDataBusinessEntity, OptionalJobPatchResponseDataBusinessEntity):
    pass
