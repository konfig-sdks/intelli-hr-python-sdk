...
class RequiredJobPatchRequestEmploymentCondition(TypedDict):
    pass

class OptionalJobPatchRequestEmploymentCondition(TypedDict, total=False):
...
class JobPatchRequestEmploymentCondition(RequiredJobPatchRequestEmploymentCondition, OptionalJobPatchRequestEmploymentCondition):
    pass
