...
class RequiredPersonDocumentsPatchResponseData(TypedDict):
    pass

class OptionalPersonDocumentsPatchResponseData(TypedDict, total=False):
...
class PersonDocumentsPatchResponseData(RequiredPersonDocumentsPatchResponseData, OptionalPersonDocumentsPatchResponseData):
    pass
