...
class RequiredRecruitmentSourcesListDataItem(TypedDict):
    pass

class OptionalRecruitmentSourcesListDataItem(TypedDict, total=False):
...
class RecruitmentSourcesListDataItem(RequiredRecruitmentSourcesListDataItem, OptionalRecruitmentSourcesListDataItem):
    pass
