...
from intelli_hr_python_sdk.pydantic.business_units_patch_request_custom_fields import BusinessUnitsPatchRequestCustomFields

class BusinessUnitsPatchRequest(BaseModel):
    ...
    custom_fields: typing.Optional[BusinessUnitsPatchRequestCustomFields] = Field(None, alias='customFields')
