...
from intelli_hr_python_sdk.pydantic.job_change_reasons_list_meta_pagination import JobChangeReasonsListMetaPagination

class JobChangeReasonsListMeta(BaseModel):
    ...
    pagination: typing.Optional[JobChangeReasonsListMetaPagination] = Field(None, alias='pagination')
