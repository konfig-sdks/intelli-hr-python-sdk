...
from intelli_hr_python_sdk.pydantic.pay_grades_list_meta_pagination import PayGradesListMetaPagination

class PayGradesListMeta(BaseModel):
    ...
    pagination: typing.Optional[PayGradesListMetaPagination] = Field(None, alias='pagination')
