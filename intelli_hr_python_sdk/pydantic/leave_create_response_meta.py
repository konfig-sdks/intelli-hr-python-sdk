...
class LeaveCreateResponseMeta(BaseModel):
    ...
    workflow_event: typing.Optional[str] = Field(None, alias='workflowEvent')

    # The identifier string for the [Workflow Event](https://developers.intellihr.io/docs/v1/).
    workflow_event_id: typing.Optional[str] = Field(None, alias='workflowEventId')
