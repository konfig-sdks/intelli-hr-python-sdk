...
from intelli_hr_python_sdk.pydantic.people_documents_find_response_meta_pagination import PeopleDocumentsFindResponseMetaPagination

class PeopleDocumentsFindResponseMeta(BaseModel):
    ...
    pagination: typing.Optional[PeopleDocumentsFindResponseMetaPagination] = Field(None, alias='pagination')
