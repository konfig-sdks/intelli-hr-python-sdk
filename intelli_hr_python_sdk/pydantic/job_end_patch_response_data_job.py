...
from intelli_hr_python_sdk.pydantic.job_end_patch_response_data_job_business_entity import JobEndPatchResponseDataJobBusinessEntity
from intelli_hr_python_sdk.pydantic.job_end_patch_response_data_job_business_unit import JobEndPatchResponseDataJobBusinessUnit
from intelli_hr_python_sdk.pydantic.job_end_patch_response_data_job_comments import JobEndPatchResponseDataJobComments
from intelli_hr_python_sdk.pydantic.job_end_patch_response_data_job_establishment import JobEndPatchResponseDataJobEstablishment
from intelli_hr_python_sdk.pydantic.job_end_patch_response_data_job_location import JobEndPatchResponseDataJobLocation
from intelli_hr_python_sdk.pydantic.job_end_patch_response_data_job_pay_grade import JobEndPatchResponseDataJobPayGrade
from intelli_hr_python_sdk.pydantic.job_end_patch_response_data_job_person import JobEndPatchResponseDataJobPerson
from intelli_hr_python_sdk.pydantic.job_end_patch_response_data_job_position_title import JobEndPatchResponseDataJobPositionTitle
from intelli_hr_python_sdk.pydantic.job_end_patch_response_data_job_recruitment import JobEndPatchResponseDataJobRecruitment
from intelli_hr_python_sdk.pydantic.job_end_patch_response_data_job_remuneration_schedule import JobEndPatchResponseDataJobRemunerationSchedule

class JobEndPatchResponseDataJob(BaseModel):
    # The identifier string for the [Job](https://developers.intellihr.io/docs/v1/).
    id: typing.Optional[str] = Field(None, alias='id')

    person: typing.Optional[JobEndPatchResponseDataJobPerson] = Field(None, alias='person')

    recruitment: typing.Optional[JobEndPatchResponseDataJobRecruitment] = Field(None, alias='recruitment')
    ...
    location: typing.Optional[JobEndPatchResponseDataJobLocation] = Field(None, alias='location')

    pay_grade: typing.Optional[JobEndPatchResponseDataJobPayGrade] = Field(None, alias='payGrade')

    business_unit: typing.Optional[JobEndPatchResponseDataJobBusinessUnit] = Field(None, alias='businessUnit')

    business_entity: typing.Optional[JobEndPatchResponseDataJobBusinessEntity] = Field(None, alias='businessEntity')

    establishment: typing.Optional[JobEndPatchResponseDataJobEstablishment] = Field(None, alias='establishment')
    ...
    remuneration_schedule: typing.Optional[JobEndPatchResponseDataJobRemunerationSchedule] = Field(None, alias='remunerationSchedule')

    # The name of this [Job](https://developers.intellihr.io/docs/v1/).
    name: typing.Optional[str] = Field(None, alias='name')

    position_title: typing.Optional[JobEndPatchResponseDataJobPositionTitle] = Field(None, alias='positionTitle')
    ...
    comments: typing.Optional[JobEndPatchResponseDataJobComments] = Field(None, alias='comments')
