...
from intelli_hr_python_sdk.pydantic.jobs_list_data_item_remuneration_schedule_additions import JobsListDataItemRemunerationScheduleAdditions
from intelli_hr_python_sdk.pydantic.jobs_list_data_item_remuneration_schedule_additions_to_total import JobsListDataItemRemunerationScheduleAdditionsToTotal
from intelli_hr_python_sdk.pydantic.jobs_list_data_item_remuneration_schedule_breakdowns import JobsListDataItemRemunerationScheduleBreakdowns
from intelli_hr_python_sdk.pydantic.jobs_list_data_item_remuneration_schedule_deductions import JobsListDataItemRemunerationScheduleDeductions
from intelli_hr_python_sdk.pydantic.jobs_list_data_item_remuneration_schedule_employment_condition import JobsListDataItemRemunerationScheduleEmploymentCondition

class JobsListDataItemRemunerationSchedule(BaseModel):
    ...
    employment_condition: typing.Optional[JobsListDataItemRemunerationScheduleEmploymentCondition] = Field(None, alias='employmentCondition')

    additions: typing.Optional[JobsListDataItemRemunerationScheduleAdditions] = Field(None, alias='additions')

    # WARNING: This property is deprecated
    deductions: typing.Optional[JobsListDataItemRemunerationScheduleDeductions] = Field(None, alias='deductions')

    additions_to_total: typing.Optional[JobsListDataItemRemunerationScheduleAdditionsToTotal] = Field(None, alias='additionsToTotal')

    breakdowns: typing.Optional[JobsListDataItemRemunerationScheduleBreakdowns] = Field(None, alias='breakdowns')
