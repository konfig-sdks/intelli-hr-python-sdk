...
class WebhookEventScheduled(BaseModel):
    ...
    scheduled_for: typing.Optional[str] = Field(None, alias='scheduled_for')

    # The current offset before the scheduled date. Enum: `-1 month`, `-14 days`, `-7 days`, `-3 days`, `-1 days`, `0 days`.
    scheduled_offset: typing.Optional[str] = Field(None, alias='scheduled_offset')
