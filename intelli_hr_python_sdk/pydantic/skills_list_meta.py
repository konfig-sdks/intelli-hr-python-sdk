...
from intelli_hr_python_sdk.pydantic.skills_list_meta_pagination import SkillsListMetaPagination

class SkillsListMeta(BaseModel):
    ...
    pagination: typing.Optional[SkillsListMetaPagination] = Field(None, alias='pagination')
