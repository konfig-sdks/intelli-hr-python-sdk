...
from intelli_hr_python_sdk.pydantic.qualifications_data_library_item import QualificationsDataLibraryItem
from intelli_hr_python_sdk.pydantic.qualifications_data_person import QualificationsDataPerson
from intelli_hr_python_sdk.pydantic.qualifications_data_qualification_status import QualificationsDataQualificationStatus
...
class QualificationsData(BaseModel):
    ...
    person: typing.Optional[QualificationsDataPerson] = Field(None, alias='person')

    # WARNING: This property is deprecated
    qualification_status: typing.Optional[QualificationsDataQualificationStatus] = Field(None, alias='qualificationStatus')
    ...
    library_item: typing.Optional[QualificationsDataLibraryItem] = Field(None, alias='libraryItem')
