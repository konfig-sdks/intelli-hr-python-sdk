...
from intelli_hr_python_sdk.pydantic.jobs_list_data_item_business_entity import JobsListDataItemBusinessEntity
from intelli_hr_python_sdk.pydantic.jobs_list_data_item_business_unit import JobsListDataItemBusinessUnit
from intelli_hr_python_sdk.pydantic.jobs_list_data_item_comments import JobsListDataItemComments
from intelli_hr_python_sdk.pydantic.jobs_list_data_item_establishment import JobsListDataItemEstablishment
from intelli_hr_python_sdk.pydantic.jobs_list_data_item_location import JobsListDataItemLocation
from intelli_hr_python_sdk.pydantic.jobs_list_data_item_pay_grade import JobsListDataItemPayGrade
from intelli_hr_python_sdk.pydantic.jobs_list_data_item_person import JobsListDataItemPerson
from intelli_hr_python_sdk.pydantic.jobs_list_data_item_position_title import JobsListDataItemPositionTitle
from intelli_hr_python_sdk.pydantic.jobs_list_data_item_recruitment import JobsListDataItemRecruitment
from intelli_hr_python_sdk.pydantic.jobs_list_data_item_remuneration_schedule import JobsListDataItemRemunerationSchedule

class JobsListDataItem(BaseModel):
    # The identifier string for the [Job](https://developers.intellihr.io/docs/v1/).
    id: typing.Optional[str] = Field(None, alias='id')

    person: typing.Optional[JobsListDataItemPerson] = Field(None, alias='person')

    recruitment: typing.Optional[JobsListDataItemRecruitment] = Field(None, alias='recruitment')
    ...
    location: typing.Optional[JobsListDataItemLocation] = Field(None, alias='location')

    pay_grade: typing.Optional[JobsListDataItemPayGrade] = Field(None, alias='payGrade')

    business_unit: typing.Optional[JobsListDataItemBusinessUnit] = Field(None, alias='businessUnit')

    business_entity: typing.Optional[JobsListDataItemBusinessEntity] = Field(None, alias='businessEntity')

    establishment: typing.Optional[JobsListDataItemEstablishment] = Field(None, alias='establishment')
    ...
    remuneration_schedule: typing.Optional[JobsListDataItemRemunerationSchedule] = Field(None, alias='remunerationSchedule')

    # The name of this [Job](https://developers.intellihr.io/docs/v1/).
    name: typing.Optional[str] = Field(None, alias='name')

    position_title: typing.Optional[JobsListDataItemPositionTitle] = Field(None, alias='positionTitle')
    ...
    comments: typing.Optional[JobsListDataItemComments] = Field(None, alias='comments')
