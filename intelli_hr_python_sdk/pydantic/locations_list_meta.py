...
from intelli_hr_python_sdk.pydantic.locations_list_meta_pagination import LocationsListMetaPagination

class LocationsListMeta(BaseModel):
    ...
    pagination: typing.Optional[LocationsListMetaPagination] = Field(None, alias='pagination')
