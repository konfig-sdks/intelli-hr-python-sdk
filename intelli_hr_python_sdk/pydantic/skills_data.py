...
from intelli_hr_python_sdk.pydantic.skills_data_skill_discipline import SkillsDataSkillDiscipline
...
class SkillsData(BaseModel):
    ...
    skill_discipline: typing.Optional[SkillsDataSkillDiscipline] = Field(None, alias='skillDiscipline')
