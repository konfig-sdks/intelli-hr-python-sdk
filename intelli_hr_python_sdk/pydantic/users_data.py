...
from intelli_hr_python_sdk.pydantic.users_data_person import UsersDataPerson
from intelli_hr_python_sdk.pydantic.users_data_user_permission_groups import UsersDataUserPermissionGroups
...
class UsersData(BaseModel):
    ...
    user_permission_groups: typing.Optional[UsersDataUserPermissionGroups] = Field(None, alias='userPermissionGroups')

    person: typing.Optional[UsersDataPerson] = Field(None, alias='person')
