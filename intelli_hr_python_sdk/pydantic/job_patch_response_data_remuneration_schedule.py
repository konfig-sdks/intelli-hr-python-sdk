...
from intelli_hr_python_sdk.pydantic.job_patch_response_data_remuneration_schedule_additions import JobPatchResponseDataRemunerationScheduleAdditions
from intelli_hr_python_sdk.pydantic.job_patch_response_data_remuneration_schedule_additions_to_total import JobPatchResponseDataRemunerationScheduleAdditionsToTotal
from intelli_hr_python_sdk.pydantic.job_patch_response_data_remuneration_schedule_breakdowns import JobPatchResponseDataRemunerationScheduleBreakdowns
from intelli_hr_python_sdk.pydantic.job_patch_response_data_remuneration_schedule_deductions import JobPatchResponseDataRemunerationScheduleDeductions
from intelli_hr_python_sdk.pydantic.job_patch_response_data_remuneration_schedule_employment_condition import JobPatchResponseDataRemunerationScheduleEmploymentCondition

class JobPatchResponseDataRemunerationSchedule(BaseModel):
    ...
    employment_condition: typing.Optional[JobPatchResponseDataRemunerationScheduleEmploymentCondition] = Field(None, alias='employmentCondition')

    additions: typing.Optional[JobPatchResponseDataRemunerationScheduleAdditions] = Field(None, alias='additions')

    # WARNING: This property is deprecated
    deductions: typing.Optional[JobPatchResponseDataRemunerationScheduleDeductions] = Field(None, alias='deductions')

    additions_to_total: typing.Optional[JobPatchResponseDataRemunerationScheduleAdditionsToTotal] = Field(None, alias='additionsToTotal')

    breakdowns: typing.Optional[JobPatchResponseDataRemunerationScheduleBreakdowns] = Field(None, alias='breakdowns')
