...
from intelli_hr_python_sdk.pydantic.job_create_response_data_business_entity import JobCreateResponseDataBusinessEntity
from intelli_hr_python_sdk.pydantic.job_create_response_data_business_unit import JobCreateResponseDataBusinessUnit
from intelli_hr_python_sdk.pydantic.job_create_response_data_comments import JobCreateResponseDataComments
from intelli_hr_python_sdk.pydantic.job_create_response_data_establishment import JobCreateResponseDataEstablishment
from intelli_hr_python_sdk.pydantic.job_create_response_data_location import JobCreateResponseDataLocation
from intelli_hr_python_sdk.pydantic.job_create_response_data_pay_grade import JobCreateResponseDataPayGrade
from intelli_hr_python_sdk.pydantic.job_create_response_data_person import JobCreateResponseDataPerson
from intelli_hr_python_sdk.pydantic.job_create_response_data_position_title import JobCreateResponseDataPositionTitle
from intelli_hr_python_sdk.pydantic.job_create_response_data_recruitment import JobCreateResponseDataRecruitment
from intelli_hr_python_sdk.pydantic.job_create_response_data_remuneration_schedule import JobCreateResponseDataRemunerationSchedule

class JobCreateResponseData(BaseModel):
    # The identifier string for the [Job](https://developers.intellihr.io/docs/v1/).
    id: typing.Optional[str] = Field(None, alias='id')

    person: typing.Optional[JobCreateResponseDataPerson] = Field(None, alias='person')

    recruitment: typing.Optional[JobCreateResponseDataRecruitment] = Field(None, alias='recruitment')
    ...
    location: typing.Optional[JobCreateResponseDataLocation] = Field(None, alias='location')

    pay_grade: typing.Optional[JobCreateResponseDataPayGrade] = Field(None, alias='payGrade')

    business_unit: typing.Optional[JobCreateResponseDataBusinessUnit] = Field(None, alias='businessUnit')

    business_entity: typing.Optional[JobCreateResponseDataBusinessEntity] = Field(None, alias='businessEntity')

    establishment: typing.Optional[JobCreateResponseDataEstablishment] = Field(None, alias='establishment')
    ...
    remuneration_schedule: typing.Optional[JobCreateResponseDataRemunerationSchedule] = Field(None, alias='remunerationSchedule')

    # The name of this [Job](https://developers.intellihr.io/docs/v1/).
    name: typing.Optional[str] = Field(None, alias='name')

    position_title: typing.Optional[JobCreateResponseDataPositionTitle] = Field(None, alias='positionTitle')
    ...
    comments: typing.Optional[JobCreateResponseDataComments] = Field(None, alias='comments')
