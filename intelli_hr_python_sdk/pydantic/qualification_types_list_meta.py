...
from intelli_hr_python_sdk.pydantic.qualification_types_list_meta_pagination import QualificationTypesListMetaPagination

class QualificationTypesListMeta(BaseModel):
    ...
    pagination: typing.Optional[QualificationTypesListMetaPagination] = Field(None, alias='pagination')
