...
from intelli_hr_python_sdk.pydantic.jobs_data_remuneration_schedule_additions import JobsDataRemunerationScheduleAdditions
from intelli_hr_python_sdk.pydantic.jobs_data_remuneration_schedule_additions_to_total import JobsDataRemunerationScheduleAdditionsToTotal
from intelli_hr_python_sdk.pydantic.jobs_data_remuneration_schedule_breakdowns import JobsDataRemunerationScheduleBreakdowns
from intelli_hr_python_sdk.pydantic.jobs_data_remuneration_schedule_deductions import JobsDataRemunerationScheduleDeductions
from intelli_hr_python_sdk.pydantic.jobs_data_remuneration_schedule_employment_condition import JobsDataRemunerationScheduleEmploymentCondition

class JobsDataRemunerationSchedule(BaseModel):
    ...
    employment_condition: typing.Optional[JobsDataRemunerationScheduleEmploymentCondition] = Field(None, alias='employmentCondition')

    additions: typing.Optional[JobsDataRemunerationScheduleAdditions] = Field(None, alias='additions')

    # WARNING: This property is deprecated
    deductions: typing.Optional[JobsDataRemunerationScheduleDeductions] = Field(None, alias='deductions')

    additions_to_total: typing.Optional[JobsDataRemunerationScheduleAdditionsToTotal] = Field(None, alias='additionsToTotal')

    breakdowns: typing.Optional[JobsDataRemunerationScheduleBreakdowns] = Field(None, alias='breakdowns')
