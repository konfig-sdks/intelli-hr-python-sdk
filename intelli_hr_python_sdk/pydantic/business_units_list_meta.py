...
from intelli_hr_python_sdk.pydantic.business_units_list_meta_pagination import BusinessUnitsListMetaPagination

class BusinessUnitsListMeta(BaseModel):
    ...
    pagination: typing.Optional[BusinessUnitsListMetaPagination] = Field(None, alias='pagination')
