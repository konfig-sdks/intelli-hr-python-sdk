...
from intelli_hr_python_sdk.pydantic.business_entities_patch_request_custom_fields import BusinessEntitiesPatchRequestCustomFields

class BusinessEntitiesPatchRequest(BaseModel):
    ...
    custom_fields: typing.Optional[BusinessEntitiesPatchRequestCustomFields] = Field(None, alias='customFields')
