...
from intelli_hr_python_sdk.pydantic.business_entities_create_request_custom_fields import BusinessEntitiesCreateRequestCustomFields

class BusinessEntitiesCreateRequest(BaseModel):
    ...
    custom_fields: typing.Optional[BusinessEntitiesCreateRequestCustomFields] = Field(None, alias='customFields')
