...
from intelli_hr_python_sdk.pydantic.job_end_remove_response_data_job_business_entity import JobEndRemoveResponseDataJobBusinessEntity
from intelli_hr_python_sdk.pydantic.job_end_remove_response_data_job_business_unit import JobEndRemoveResponseDataJobBusinessUnit
from intelli_hr_python_sdk.pydantic.job_end_remove_response_data_job_comments import JobEndRemoveResponseDataJobComments
from intelli_hr_python_sdk.pydantic.job_end_remove_response_data_job_establishment import JobEndRemoveResponseDataJobEstablishment
from intelli_hr_python_sdk.pydantic.job_end_remove_response_data_job_location import JobEndRemoveResponseDataJobLocation
from intelli_hr_python_sdk.pydantic.job_end_remove_response_data_job_pay_grade import JobEndRemoveResponseDataJobPayGrade
from intelli_hr_python_sdk.pydantic.job_end_remove_response_data_job_person import JobEndRemoveResponseDataJobPerson
from intelli_hr_python_sdk.pydantic.job_end_remove_response_data_job_position_title import JobEndRemoveResponseDataJobPositionTitle
from intelli_hr_python_sdk.pydantic.job_end_remove_response_data_job_recruitment import JobEndRemoveResponseDataJobRecruitment
from intelli_hr_python_sdk.pydantic.job_end_remove_response_data_job_remuneration_schedule import JobEndRemoveResponseDataJobRemunerationSchedule

class JobEndRemoveResponseDataJob(BaseModel):
    # The identifier string for the [Job](https://developers.intellihr.io/docs/v1/).
    id: typing.Optional[str] = Field(None, alias='id')

    person: typing.Optional[JobEndRemoveResponseDataJobPerson] = Field(None, alias='person')

    recruitment: typing.Optional[JobEndRemoveResponseDataJobRecruitment] = Field(None, alias='recruitment')
    ...
    location: typing.Optional[JobEndRemoveResponseDataJobLocation] = Field(None, alias='location')

    pay_grade: typing.Optional[JobEndRemoveResponseDataJobPayGrade] = Field(None, alias='payGrade')

    business_unit: typing.Optional[JobEndRemoveResponseDataJobBusinessUnit] = Field(None, alias='businessUnit')

    business_entity: typing.Optional[JobEndRemoveResponseDataJobBusinessEntity] = Field(None, alias='businessEntity')

    establishment: typing.Optional[JobEndRemoveResponseDataJobEstablishment] = Field(None, alias='establishment')
    ...
    remuneration_schedule: typing.Optional[JobEndRemoveResponseDataJobRemunerationSchedule] = Field(None, alias='remunerationSchedule')

    # The name of this [Job](https://developers.intellihr.io/docs/v1/).
    name: typing.Optional[str] = Field(None, alias='name')

    position_title: typing.Optional[JobEndRemoveResponseDataJobPositionTitle] = Field(None, alias='positionTitle')
    ...
    comments: typing.Optional[JobEndRemoveResponseDataJobComments] = Field(None, alias='comments')
