...
from intelli_hr_python_sdk.pydantic.permission_groups_list_meta_pagination import PermissionGroupsListMetaPagination

class PermissionGroupsListMeta(BaseModel):
    ...
    pagination: typing.Optional[PermissionGroupsListMetaPagination] = Field(None, alias='pagination')
