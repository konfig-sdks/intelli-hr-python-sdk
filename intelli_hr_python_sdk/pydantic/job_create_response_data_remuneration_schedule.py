...
from intelli_hr_python_sdk.pydantic.job_create_response_data_remuneration_schedule_additions import JobCreateResponseDataRemunerationScheduleAdditions
from intelli_hr_python_sdk.pydantic.job_create_response_data_remuneration_schedule_additions_to_total import JobCreateResponseDataRemunerationScheduleAdditionsToTotal
from intelli_hr_python_sdk.pydantic.job_create_response_data_remuneration_schedule_breakdowns import JobCreateResponseDataRemunerationScheduleBreakdowns
from intelli_hr_python_sdk.pydantic.job_create_response_data_remuneration_schedule_deductions import JobCreateResponseDataRemunerationScheduleDeductions
from intelli_hr_python_sdk.pydantic.job_create_response_data_remuneration_schedule_employment_condition import JobCreateResponseDataRemunerationScheduleEmploymentCondition

class JobCreateResponseDataRemunerationSchedule(BaseModel):
    ...
    employment_condition: typing.Optional[JobCreateResponseDataRemunerationScheduleEmploymentCondition] = Field(None, alias='employmentCondition')

    additions: typing.Optional[JobCreateResponseDataRemunerationScheduleAdditions] = Field(None, alias='additions')

    # WARNING: This property is deprecated
    deductions: typing.Optional[JobCreateResponseDataRemunerationScheduleDeductions] = Field(None, alias='deductions')

    additions_to_total: typing.Optional[JobCreateResponseDataRemunerationScheduleAdditionsToTotal] = Field(None, alias='additionsToTotal')

    breakdowns: typing.Optional[JobCreateResponseDataRemunerationScheduleBreakdowns] = Field(None, alias='breakdowns')
