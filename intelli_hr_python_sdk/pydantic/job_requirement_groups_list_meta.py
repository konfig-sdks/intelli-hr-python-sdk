...
from intelli_hr_python_sdk.pydantic.job_requirement_groups_list_meta_pagination import JobRequirementGroupsListMetaPagination

class JobRequirementGroupsListMeta(BaseModel):
    ...
    pagination: typing.Optional[JobRequirementGroupsListMetaPagination] = Field(None, alias='pagination')
