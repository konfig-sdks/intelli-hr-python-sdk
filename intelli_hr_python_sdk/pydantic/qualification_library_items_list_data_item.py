...
from intelli_hr_python_sdk.pydantic.qualification_library_items_list_data_item_qualification_type import QualificationLibraryItemsListDataItemQualificationType

class QualificationLibraryItemsListDataItem(BaseModel):
    ...
    qualification_type: typing.Optional[QualificationLibraryItemsListDataItemQualificationType] = Field(None, alias='qualificationType')
