...
from intelli_hr_python_sdk.pydantic.representative_types_list_meta_pagination import RepresentativeTypesListMetaPagination

class RepresentativeTypesListMeta(BaseModel):
    ...
    pagination: typing.Optional[RepresentativeTypesListMetaPagination] = Field(None, alias='pagination')
