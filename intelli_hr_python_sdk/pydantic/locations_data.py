...
from intelli_hr_python_sdk.pydantic.locations_data_representatives import LocationsDataRepresentatives
...
class LocationsData(BaseModel):
    ...
    representatives: typing.Optional[LocationsDataRepresentatives] = Field(None, alias='representatives')
