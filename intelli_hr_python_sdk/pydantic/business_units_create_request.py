...
from intelli_hr_python_sdk.pydantic.business_units_create_request_custom_fields import BusinessUnitsCreateRequestCustomFields

class BusinessUnitsCreateRequest(BaseModel):
    ...
    custom_fields: typing.Optional[BusinessUnitsCreateRequestCustomFields] = Field(None, alias='customFields')
