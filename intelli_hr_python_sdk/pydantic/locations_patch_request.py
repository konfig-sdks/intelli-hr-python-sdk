...
from intelli_hr_python_sdk.pydantic.locations_patch_request_custom_fields import LocationsPatchRequestCustomFields

class LocationsPatchRequest(BaseModel):
    ...
    custom_fields: typing.Optional[LocationsPatchRequestCustomFields] = Field(None, alias='customFields')
