...
from intelli_hr_python_sdk.pydantic.job_end_remove_response_data_job_remuneration_schedule_additions import JobEndRemoveResponseDataJobRemunerationScheduleAdditions
from intelli_hr_python_sdk.pydantic.job_end_remove_response_data_job_remuneration_schedule_additions_to_total import JobEndRemoveResponseDataJobRemunerationScheduleAdditionsToTotal
from intelli_hr_python_sdk.pydantic.job_end_remove_response_data_job_remuneration_schedule_breakdowns import JobEndRemoveResponseDataJobRemunerationScheduleBreakdowns
from intelli_hr_python_sdk.pydantic.job_end_remove_response_data_job_remuneration_schedule_deductions import JobEndRemoveResponseDataJobRemunerationScheduleDeductions
from intelli_hr_python_sdk.pydantic.job_end_remove_response_data_job_remuneration_schedule_employment_condition import JobEndRemoveResponseDataJobRemunerationScheduleEmploymentCondition

class JobEndRemoveResponseDataJobRemunerationSchedule(BaseModel):
    ...
    employment_condition: typing.Optional[JobEndRemoveResponseDataJobRemunerationScheduleEmploymentCondition] = Field(None, alias='employmentCondition')

    additions: typing.Optional[JobEndRemoveResponseDataJobRemunerationScheduleAdditions] = Field(None, alias='additions')

    # WARNING: This property is deprecated
    deductions: typing.Optional[JobEndRemoveResponseDataJobRemunerationScheduleDeductions] = Field(None, alias='deductions')

    additions_to_total: typing.Optional[JobEndRemoveResponseDataJobRemunerationScheduleAdditionsToTotal] = Field(None, alias='additionsToTotal')

    breakdowns: typing.Optional[JobEndRemoveResponseDataJobRemunerationScheduleBreakdowns] = Field(None, alias='breakdowns')
