...
from intelli_hr_python_sdk.pydantic.business_entities_list_meta_pagination import BusinessEntitiesListMetaPagination

class BusinessEntitiesListMeta(BaseModel):
    ...
    pagination: typing.Optional[BusinessEntitiesListMetaPagination] = Field(None, alias='pagination')
