...
from intelli_hr_python_sdk.pydantic.pay_grades_list_data_item_pay_grade_values import PayGradesListDataItemPayGradeValues

class PayGradesListDataItem(BaseModel):
    ...
    pay_grade_values: typing.Optional[PayGradesListDataItemPayGradeValues] = Field(None, alias='payGradeValues')
