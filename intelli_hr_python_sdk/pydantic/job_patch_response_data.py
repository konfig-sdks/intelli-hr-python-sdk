...
from intelli_hr_python_sdk.pydantic.job_patch_response_data_business_entity import JobPatchResponseDataBusinessEntity
from intelli_hr_python_sdk.pydantic.job_patch_response_data_business_unit import JobPatchResponseDataBusinessUnit
from intelli_hr_python_sdk.pydantic.job_patch_response_data_comments import JobPatchResponseDataComments
from intelli_hr_python_sdk.pydantic.job_patch_response_data_establishment import JobPatchResponseDataEstablishment
from intelli_hr_python_sdk.pydantic.job_patch_response_data_location import JobPatchResponseDataLocation
from intelli_hr_python_sdk.pydantic.job_patch_response_data_pay_grade import JobPatchResponseDataPayGrade
from intelli_hr_python_sdk.pydantic.job_patch_response_data_person import JobPatchResponseDataPerson
from intelli_hr_python_sdk.pydantic.job_patch_response_data_position_title import JobPatchResponseDataPositionTitle
from intelli_hr_python_sdk.pydantic.job_patch_response_data_recruitment import JobPatchResponseDataRecruitment
from intelli_hr_python_sdk.pydantic.job_patch_response_data_remuneration_schedule import JobPatchResponseDataRemunerationSchedule

class JobPatchResponseData(BaseModel):
    # The identifier string for the [Job](https://developers.intellihr.io/docs/v1/).
    id: typing.Optional[str] = Field(None, alias='id')

    person: typing.Optional[JobPatchResponseDataPerson] = Field(None, alias='person')

    recruitment: typing.Optional[JobPatchResponseDataRecruitment] = Field(None, alias='recruitment')
    ...
    location: typing.Optional[JobPatchResponseDataLocation] = Field(None, alias='location')

    pay_grade: typing.Optional[JobPatchResponseDataPayGrade] = Field(None, alias='payGrade')

    business_unit: typing.Optional[JobPatchResponseDataBusinessUnit] = Field(None, alias='businessUnit')

    business_entity: typing.Optional[JobPatchResponseDataBusinessEntity] = Field(None, alias='businessEntity')

    establishment: typing.Optional[JobPatchResponseDataEstablishment] = Field(None, alias='establishment')
    ...
    remuneration_schedule: typing.Optional[JobPatchResponseDataRemunerationSchedule] = Field(None, alias='remunerationSchedule')

    # The name of this [Job](https://developers.intellihr.io/docs/v1/).
    name: typing.Optional[str] = Field(None, alias='name')

    position_title: typing.Optional[JobPatchResponseDataPositionTitle] = Field(None, alias='positionTitle')
    ...
    comments: typing.Optional[JobPatchResponseDataComments] = Field(None, alias='comments')
