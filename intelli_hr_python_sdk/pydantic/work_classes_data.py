...
from intelli_hr_python_sdk.pydantic.work_classes_data_work_type import WorkClassesDataWorkType

class WorkClassesData(BaseModel):
    ...
    work_type: typing.Optional[WorkClassesDataWorkType] = Field(None, alias='workType')
