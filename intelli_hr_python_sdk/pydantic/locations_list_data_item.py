...
from intelli_hr_python_sdk.pydantic.locations_list_data_item_representatives import LocationsListDataItemRepresentatives

class LocationsListDataItem(BaseModel):
    ...
    representatives: typing.Optional[LocationsListDataItemRepresentatives] = Field(None, alias='representatives')
