...
from intelli_hr_python_sdk.pydantic.qualifications_list_meta_pagination import QualificationsListMetaPagination

class QualificationsListMeta(BaseModel):
    ...
    pagination: typing.Optional[QualificationsListMetaPagination] = Field(None, alias='pagination')
